...
```bash
$ oc create -f https://raw.githubusercontent.com/bnovakrh/pipelines-tutorial/master/01_pipeline/01_apply_manifest_task.yaml

$ oc create -f https://raw.githubusercontent.com/bnovakrh/pipelines-tutorial/master/01_pipeline/02_update_deployment_task.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/bnovakrh/pipelines-tutorial/master/01_pipeline/04_pipeline.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/bnovakrh/pipelines-tutorial/master/01_pipeline/03_resources.yaml
```
